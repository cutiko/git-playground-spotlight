<template>
  <div class="flex flex-row p-4 rounded border-2 border-gray-300">
    <img class="rounded-full avatar" :src="pr.user.avatar_url">
    <a :href="pr.user.login | githubLink" target="_blank" rel="noreferrer" class="mx-6 py-2 flex-grow">{{pr.user.login}}</a>
